...
`timescale 1ns/1ps
module FFT_TOP_FFT_DIT_spatial_unroll_CY_stream_vector_FFT_DIT_spatial_unroll_CY_stream_vectHfu
#(parameter
    DataWidth    = 32,
    AddressRange = 64,
    AddressWidth = 6,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        FFT_TOP_FFT_DIT_spatial_unroll_CY_stream_vector_FFT_DIT_spatial_unroll_CY_stream_vectHfu_memcore FFT_TOP_FFT_DIT_spatial_unroll_CY_stream_vector_FFT_DIT_spatial_unroll_CY_stream_vectHfu_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
            .address0 ( buf_a0[i] ),
            .d0       ( buf_d0[i] ),
