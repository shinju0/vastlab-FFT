...
HLS_SOURCES = ../../../../testbench.cpp ../../../../FFT.cpp

override TARGET := csim.exe

AUTOPILOT_ROOT := /opt/xilinx/tools/Vitis/2024.2
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /opt/xilinx/tools/Vitis/2024.2/tps/lnx64/gcc-8.3.0/bin
endif
...
CCFLAG += --gcc-toolchain=/opt/xilinx/tools/Vitis/2024.2/tps/lnx64/gcc-8.3.0
CCFLAG += -Werror=uninitialized
CCFLAG += -Wno-c++11-narrowing
CCFLAG += -Wno-error=sometimes-uninitialized
LFLAG += --gcc-toolchain=/opt/xilinx/tools/Vitis/2024.2/tps/lnx64/gcc-8.3.0
...
$(ObjDir)/FFT.o: ../../../../FFT.cpp $(ObjDir)/.dir csim.mk
