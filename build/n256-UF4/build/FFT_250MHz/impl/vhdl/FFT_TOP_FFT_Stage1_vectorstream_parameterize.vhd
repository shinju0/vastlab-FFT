...
entity FFT_TOP_FFT_Stage1_vectorstream_parameterize is
port (
...
architecture behav of FFT_TOP_FFT_Stage1_vectorstream_parameterize is 
...
attribute shreg_extract : string;
    ...
    signal FFT_Stage1_vectorstream_parameterize_Loop_FFT_Stage1_proc_U0_data_s1_stream_vector_din : STD_LOGIC_VECTOR (511 downto 0);
    signal FFT_Stage1_vectorstream_parameterize_Loop_FFT_Stage1_proc_U0_data_s1_stream_vector_write : STD_LOGIC;

    component FFT_TOP_FFT_Stage1_vectorstream_parameterize_Loop_FFT_Stage1_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    FFT_Stage1_vectorstream_parameterize_Loop_FFT_Stage1_proc_U0 : component FFT_TOP_FFT_Stage1_vectorstream_parameterize_Loop_FFT_Stage1_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
