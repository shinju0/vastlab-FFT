...
`timescale 1ns/1ps
module FFT_TOP_FFT_DIT_spatial_unroll_CY_stream_vector_FFT_DIT_spatial_unroll_CY_stream_vectbkb
#(parameter
    DataWidth    = 32,
    AddressRange = 32,
    AddressWidth = 5,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        FFT_TOP_FFT_DIT_spatial_unroll_CY_stream_vector_FFT_DIT_spatial_unroll_CY_stream_vectbkb_memcore FFT_TOP_FFT_DIT_spatial_unroll_CY_stream_vector_FFT_DIT_spatial_unroll_CY_stream_vectbkb_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .address0 ( buf_a0[i] ),
            .q0       ( buf_q0[i] ),
            .ce1      ( buf_ce1[i] ),
