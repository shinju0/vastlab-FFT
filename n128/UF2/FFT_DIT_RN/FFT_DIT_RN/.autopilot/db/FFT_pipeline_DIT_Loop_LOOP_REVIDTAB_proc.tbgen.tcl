set moduleName FFT_pipeline_DIT_Loop_LOOP_REVIDTAB_proc
set isTopModule 0
...
set cdfgNum 22
set C_modelName {FFT_pipeline_DIT_Loop_LOOP_REVIDTAB_proc}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict revIdxTab { MEM_WIDTH 7 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
...
set portList { 
	...
	{ revIdxTab_we0 sc_out sc_logic 1 signal 0 } 
	{ revIdxTab_d0 sc_out sc_lv 7 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	revIdxTab { ap_memory {  { revIdxTab_address0 mem_address 1 7 }  { revIdxTab_ce0 mem_ce 1 1 }  { revIdxTab_we0 mem_we 1 1 }  { revIdxTab_d0 mem_din 1 7 } } }
}
