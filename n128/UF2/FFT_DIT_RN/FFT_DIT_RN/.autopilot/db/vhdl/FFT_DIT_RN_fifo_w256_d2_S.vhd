...
entity FFT_DIT_RN_fifo_w256_d2_S is 
    generic (
...
architecture rtl of FFT_DIT_RN_fifo_w256_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component FFT_DIT_RN_fifo_w256_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 256;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_FFT_DIT_RN_fifo_w256_d2_S_ShiftReg : FFT_DIT_RN_fifo_w256_d2_S_ShiftReg
    generic map (
...
entity FFT_DIT_RN_fifo_w256_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 256;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end FFT_DIT_RN_fifo_w256_d2_S_ShiftReg;

architecture rtl of FFT_DIT_RN_fifo_w256_d2_S_ShiftReg is
