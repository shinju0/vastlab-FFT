...
// wrapc file define:
#define AUTOTB_TVIN_in_r "../tv/cdatafile/c.FFT_DIT_RN.autotvin_in_r.dat"
...
#define AUTOTB_TVOUT_out_r "../tv/cdatafile/c.FFT_DIT_RN.autotvout_out_r.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_out_r "../tv/rtldatafile/rtl.FFT_DIT_RN.autotvout_out_r.dat"
...
extern "C"
void FFT_DIT_RN_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_FFT_DIT_RN_hw(void* __xlx_apatb_param_in_r, void* __xlx_apatb_param_out_r)
{
  ...
  port0.param = (hls::stream<hls::sim::Byte<32>>*)__xlx_apatb_param_in_r;
  ...
  port1.param = (hls::stream<hls::sim::Byte<32>>*)__xlx_apatb_param_out_r;
  port1.hasWrite = true;
  ...
  try {
    ...
    FFT_DIT_RN_hw_stub_wrapper(__xlx_apatb_param_in_r, __xlx_apatb_param_out_r);
    port1.buffer();
