; ModuleID = '/scratch/juju/HP-FFT-HLS/n128/UF2/FFT_DIT_RN/FFT_DIT_RN/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_FFT_DIT_RN_ir(%"class.hls::stream<hls::vector<std::complex<float>, 4>, 0>"* noalias nocapture nonnull dereferenceable(32) %in, %"class.hls::stream<hls::vector<std::complex<float>, 4>, 0>"* noalias nocapture nonnull dereferenceable(32) %out) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_FFT_DIT_RN_hw(i256* %in_copy, i256* %out_copy)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::vector<std::complex<float>, 4>, 0>.159"(i256* align 512 %1, %"class.hls::stream<hls::vector<std::complex<float>, 4>, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::vector<std::complex<float>, 4>, 0>.159"(i256* align 512 %3, %"class.hls::stream<hls::vector<std::complex<float>, 4>, 0>"* %2)
  ret void
}
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::vector<std::complex<float>, 4>, 0>.154"(%"class.hls::stream<hls::vector<std::complex<float>, 4>, 0>"* nonnull %dst, i256* nonnull align 512 %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::vector<std::complex<float>, 4>, 0>.154"(%"class.hls::stream<hls::vector<std::complex<float>, 4>, 0>"* noalias nocapture, i256* noalias nocapture align 512) unnamed_addr #5 {
entry:
  %2 = alloca i256
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::vector<std::complex<float>, 4>, 0>.159"(i256* noalias align 512 %dst, %"class.hls::stream<hls::vector<std::complex<float>, 4>, 0>"* noalias %src) unnamed_addr #4 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::vector<std::complex<float>, 4>, 0>.162"(i256* nonnull align 512 %dst, %"class.hls::stream<hls::vector<std::complex<float>, 4>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::vector<std::complex<float>, 4>, 0>.162"(i256* noalias nocapture align 512, %"class.hls::stream<hls::vector<std::complex<float>, 4>, 0>"* noalias nocapture) unnamed_addr #5 {
entry:
...
declare void @apatb_FFT_DIT_RN_hw(i256*, i256*)
...
declare void @FFT_DIT_RN_hw_stub(%"class.hls::stream<hls::vector<std::complex<float>, 4>, 0>"* noalias nocapture nonnull, %"class.hls::stream<hls::vector<std::complex<float>, 4>, 0>"* noalias nocapture nonnull)

define void @FFT_DIT_RN_hw_stub_wrapper(i256*, i256*) #7 {
entry:
  ...
  call void @FFT_DIT_RN_hw_stub(%"class.hls::stream<hls::vector<std::complex<float>, 4>, 0>"* %3, %"class.hls::stream<hls::vector<std::complex<float>, 4>, 0>"* %5)
